...
CustomGetTileUrl=function(a,b,c) {
	...
	// Build the image URL
	var lURL = this.myBaseURL + "REQUEST=GetMap&SERVICE=WMS&VERSION=1.1.1";
	lURL += "&LAYERS=" + this.myLayers + "&STYLES=" + this.myStyles + "&FORMAT=" + this.myFormat;
	lURL += "&BGCOLOR=0xFFFFFF&TRANSPARENT=TRUE&WIDTH=256&HEIGHT=256&reaspect=false";
	lURL += "&SRS=" + lSRS + "&BBOX=" + lBbox;
	return lURL;
}
