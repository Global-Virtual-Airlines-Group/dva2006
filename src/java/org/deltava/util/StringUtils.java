...
public final class StringUtils {
   ...
   /**
    * Returns the method name used to retrieve a particular property value. This conforms to the Java Bean specification
    * by prepending the string &quot;get&quot; to the property name, and converting the first character of the property
    * name to uppercase.
   ...
   public static List<String> split(String s, String delim) {
      ...
      if (!"".equals(lastEntry)) results.add(lastEntry);
