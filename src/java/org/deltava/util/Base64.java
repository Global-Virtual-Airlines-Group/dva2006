...
public class Base64 {
    ...
    protected final static byte[] DECODABET = { -9, -9, -9, -9, -9, -9, -9, -9,
            -9, // Decimal 0 - 8
     ...
     * @since 1.3
     */
    protected static byte[] encode3to4(byte[] threeBytes, int numSigBytes) {
    ...
    public static byte[] decode(byte[] source, int off, int len) {
        int len34 = len * 3 / 4;
        byte[] outBuff = new byte[len34]; // Upper limit on size
        // of output
        int outBuffPosn = 0;
    ...
    public static class InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Calls read repeatedly until the end of stream is reached or <var>len
         * </var> bytes are read. Returns number of bytes read into array or -1
