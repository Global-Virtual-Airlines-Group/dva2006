 ...
 *  Released as 1.6.</li>
 * <li><strong>2005-01-21</strong> Luke hacked up the class from 1.6, removing the main() method and
 * refactoring the constructors so that they could take a byte[] or an InputStream directly.</li>
 * </ul>
...
public class ImageInfo {
	 ...
	 * @param is the stream containing the image
	 */
