...
/**
 * A JSP tag to insert optionally minified content. Content will be minified if the
 * SystemData environment name starts with &quot;prod&quot;.
 * @author Luke
 * @version 5.0
 * @since 5.0
 */
...
abstract class InsertMinifiedContentTag extends InsertContentTag {
	...
	/**
	 * Determines whether content is minified.
	 */
	@Override
	public int doStartTag() {
		...
		boolean minOV = Boolean.valueOf(pageContext.getRequest().getParameter("minOV")).booleanValue();
