// Copyright 2005, 2010, 2011, 2014, 2016, 2018 Global Virtual Airlines Group. All Rights Reserved.
...
public class GetPilotNotify extends GetPilot {
   ...
   public List<EMailAddress> getNotifications(Notification notificationType) throws DAOException {
      try {
         prepareStatement("SELECT CONCAT_WS(' ', FIRSTNAME, LASTNAME) AS NM, EMAIL FROM PILOTS WHERE (STATUS=?) AND ((NOTIFY & ?) > 0) ORDER BY LASTNAME, FIRSTNAME");
