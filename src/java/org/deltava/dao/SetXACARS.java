...
public class SetXACARS extends DAO {
	...
	public void write(XARouteEntry pos) throws DAOException {
		...
		try {
			...
			_ps.setInt(7, pos.getHeading());
			_ps.setInt(8, pos.getAirSpeed());
			_ps.setInt(9, pos.getGroundSpeed());
			_ps.setInt(10, pos.getVerticalSpeed());
			_ps.setDouble(11, pos.getMach());
			_ps.setInt(12, pos.getFuelRemaining());
			_ps.setInt(13, pos.getPhase().ordinal());
			_ps.setInt(14, pos.getWindHeading());
			_ps.setInt(15, pos.getWindSpeed());
			_ps.setInt(16, pos.getFlags());
			_ps.setString(17, pos.getMessageType());
			executeUpdate(1);
		} catch (SQLException se) {
			throw new DAOException(se);
		}
