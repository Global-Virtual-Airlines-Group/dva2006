...
public class SetFlightReport extends DAO {
	...
	/**
	 * Writes an ACARS-enabled Flight Report into the database. Since the ACARS data can never be updated,
	 * it is OK for this method to online support INSERT operations, and not UPDATEs. Should behavior change in
	 * the future, this will need to be rewritten to support UPDATEs.
	 * @param afr the Flight Report
	 * @throws DAOException if a JDBC error occurs
	 */
	public void writeACARS(ACARSFlightReport afr) throws DAOException {
		...
		try {
			...
			prepareStatementWithoutLimits("INSERT INTO ACARS_PIREPS (ID, ACARS_ID, START_TIME, ENGINE_START, " +
					...
					"TAKEOFF_WEIGHT, TAKEOFF_FUEL, LANDING_TIME, LANDING_DISTANCE, LANDING_SPEED, LANDING_VPSEED, " +
