...
public class GetApplicant extends DAO {
	...
	private List execute() throws SQLException {
		...
		while (rs.next()) {
			...
			a.setDN(rs.getString(6));
			a.setEmail(rs.getString(7));
			a.setLocation(rs.getString(8));
			a.setIMHandle(rs.getString(9));
			a.setNetworkID("VATSIM", rs.getString(10));
			a.setNetworkID("IVAO", rs.getString(11));
			...
			a.setLoginCount(rs.getInt(23));
			a.setLastLogin(rs.getTimestamp(24));
			a.setLastLogoff(rs.getTimestamp(25));
			a.setLoginHost(rs.getString(26));
			a.setRegisterHostName(rs.getString(27));
			a.setDateFormat(rs.getString(28));
			a.setTimeFormat(rs.getString(29));
			a.setNumberFormat(rs.getString(30));
			a.setAirportCodeType(rs.getInt(31));
			a.setTZ(TZInfo.init(rs.getString(32)));
