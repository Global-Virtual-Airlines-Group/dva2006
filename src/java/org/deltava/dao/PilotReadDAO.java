...
abstract class PilotReadDAO extends PilotDAO {
	...
	protected final List<Pilot> execute() throws SQLException {
		...
		while (rs.next()) {
			...
			// Check if this result set has a column 49, which is the signature extension
			if (columnCount > 48)
