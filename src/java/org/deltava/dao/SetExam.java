...
public class SetExam extends DAO {
   ...
   /**
    * Writes a new Pilot Examination to the database. This will update the database ID for the Examination bean
    * with the automatically generated ID column value.
