// Copyright 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2014, 2016, 2017, 2020, 2026 Global Virtual Airlines Group. All Rights Reserved.
	...
	public void execute(CommandContext ctx) throws CommandException {
		...
		try {
			...
			for (Iterator<Signup> i = e.getSignups().iterator(); i.hasNext(); ) {
				...
				fr.addStatusUpdate(ctx.getUser().getID(), HistoryType.LIFECYCLE, "Assigned for Online Event " + e.getName());
