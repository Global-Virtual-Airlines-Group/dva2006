...
public class RouteEntry implements Comparable, GeoLocation, Serializable, MapEntry {
   ...
   public void setAltitude(int alt) {
      if ((alt < -300) || (alt > 100000)) throw new IllegalArgumentException("Altitude cannot be < -300 or > 100000");
   ...
   public void setHeading(int hdg) {
      if ((hdg < 0) || (hdg > 360)) throw new IllegalArgumentException("Heading cannot be < 0 or > 360 degrees");
   ...
   public void setAirSpeed(int speed) {
      if ((speed < -20) || (speed > 700)) throw new IllegalArgumentException("Airspeed cannot be < -20 or > 700");
   ...
   public void setGroundSpeed(int speed) {
      if ((speed < -5) || (speed > 1500)) throw new IllegalArgumentException("Ground speed cannot be < -5 or > 1500");
   ...
   public void setN1(double nn1) {
      if ((nn1 < 0) || (nn1 > 115.0)) throw new IllegalArgumentException("N1 cannot be negative or > 115.0%");
   ...
   public void setN2(double nn2) {
      if ((nn2 < 0) || (nn2 > 115.0)) throw new IllegalArgumentException("N2 cannot be negative or > 115.0%");
