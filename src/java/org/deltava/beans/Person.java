...
public abstract class Person extends DatabaseBlobBean implements Principal, EMailAddress, ViewEntry {
     ...
     * @return the unencrypted password. This will only be non-null when changing a password or registering a new Person.
     ...
     * @param location the location where this Person lives. It is up to the implementation as to what are valid choices.
