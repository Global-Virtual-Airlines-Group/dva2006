...
public class Runway extends NavigationDataBean {
   ...
   public void setLength(int len) {
      if ((len < 1) || (len > 25000)) throw new IllegalArgumentException("Length cannot be < 1 or > 25000");
   ...
   public void setHeading(int hdg) {
      if ((hdg < 0) || (hdg > 360)) throw new IllegalArgumentException("Invalid Heading - " + hdg);
