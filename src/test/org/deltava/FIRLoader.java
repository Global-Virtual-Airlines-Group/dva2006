...
public class FIRLoader extends TestCase {
	...
	//private static final String JDBC_URL = "jdbc:mysql://pollux.gvagroup.org/common";
	...
	public void testLoadFIRs() throws Exception {
		...
		PreparedStatement ps = _c.prepareStatement("REPLACE INTO FIR (ID, OCEANIC, NAME) VALUES (?, ?, ?)");
		PreparedStatement ps2 = _c.prepareStatement("INSERT INTO FIRDATA (ID, OCEANIC, SEQ, LAT, LNG) VALUES (?, ?, ?, ?, ?)");
	...
	public void testLoadFIRAliases() throws Exception {
		...
		PreparedStatement ps = _c.prepareStatement("REPLACE INTO FIRALIAS (ID, OCEANIC, ALIAS) VALUES (?, ?, ?)");
