...
public class PlotLocalMap extends PlotMap {
	...
	private static final List<String> _airports = Arrays.asList("ATL", "JFK", "LAX", "SLC", "YYZ", "MIA", "MSP", "DTW", "BOS", "SEA", "LAS", "SAN", "SFO", "NRT", 
			"MCO", "DFW", "IAD", "CDG", "AMS", "HKX", "HKG", "HNL", "OGG", "CVG", "YUL", "LHR", "ICN", "BDA", "YVR", "SYD", "ZRH"); 
	
	protected void setUp() throws Exception {
		super.setUp();
		_zooms.put(Integer.valueOf(10), new ProjectInfo(10, 36, 5));
		_zooms.put(Integer.valueOf(11), new ProjectInfo(11, 28, 4));
		_zooms.put(Integer.valueOf(12), new ProjectInfo(12, 22, 4));
		_zooms.put(Integer.valueOf(13), new ProjectInfo(13, 18, 3));
	}
