...
<tr class="sbData">
 ...
 <td class="data"><el:combo name="sbFormat" size="1" options="${sbFmts}" value="${pkgType}" /> - Weight unit: <el:check type="radio" cols="2" name="sbWeightUnit" options="${weightUnits}" value="${pilot.weightType}" /></td>
</tr>
