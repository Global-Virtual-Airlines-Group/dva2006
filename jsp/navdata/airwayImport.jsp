...
<tr>
 ...
 <td class="data"><el:file name="navData" idx="*" className="small req" size="80" max="144" />&nbsp;<span class="small ita">AIRAC data must be in PSS Format.</span></td>
</tr>
<tr>
 <td class="label">&nbsp;</td>
...
<tr>
 <td><el:button type="submit" label="UPLOAD AIRAC AIRWAY DATA" /></td>
</tr>
</el:table>
</el:form>
<br />
