...
<tr>
 <td class="label">&nbsp;</td>
 <td class="data" colspan="2"><el:box name="doImport" value="true" label="Import AviationStack Data" /><br>
<el:box name="doForce" value="true" label="Force AviationStack re-Import" /></td>
</tr>
<content:hasmsg>
<tr>
 <td class="label">&nbsp;</td>
