...
<el:form action="courseride.do" method="post" linkID="0x${course.ID}" validate="return validate(this)">
...
<el:cmdbutton ID="CourseButton" url="course" linkID="0x${course.ID}" label="VIEW COURSE" /> 
