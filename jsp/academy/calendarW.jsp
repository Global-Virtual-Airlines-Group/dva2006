...
<c:if test="${isMine}">
 <td width="10%"><el:cmd url="academycalendar" op="7" linkID="0&amp;startDate=${startDate}">ALL SESSIONS</el:cmd></td>
</c:if>
<c:if test="${!isMine && !empty user}">
 <td width="10%"><el:cmd url="academycalendar" op="7" linkID="0x${user.ID}&amp;startDate=${startDate}">MY SESSIONS</el:cmd></td>
</c:if>
