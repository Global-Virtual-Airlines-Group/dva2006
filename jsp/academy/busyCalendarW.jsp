...
<div class="mid">
<calendar:week date="cDate" startDate="${startDate}" entries="${accessMap.keySet()}" topBarClass="dayHdr" dayBarClass="dayHdr" tableClass="calendar" contentClass="contentW" scrollClass="scroll" cmd="busycalendar">
