...
<tr>
 <td>
<el:button type="submit" label="SAVE MESSAGE TEMPLATE" />
<c:if test="${access.canDelete}">&nbsp;<el:cmdbutton url="msgtemplatedelete" linkID="${template.name}" label="DELETE MESSAGE TEMPLATE" /></c:if> </td>
</tr>
</el:table>
</el:form>
<br />
