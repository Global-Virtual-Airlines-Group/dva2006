...
<html lang="en">
<head>
<title><content:airline /> Network Location Import</title>
...
<el:form action="ipgeoimport.do" method="post" validate="return golgotha.form.wrap(golgotha.local.validate, this)">
<el:table className="form">
<tr class="title caps">
 <td colspan="2">GEOLITE CITY NETWORK LOCATION BLOCK UPLOAD</td>
</tr>
<tr id="selectFile">
 <td class="label top">Location File</td>
