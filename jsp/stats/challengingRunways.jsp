...
<tr>
 ...
 <td><span class="pri bld">${rls.runway}</span><span class="nophone"> - <fmt:int value="${rwy.length}" /> feet, ${rwy.heading} degrees</span><c:if test="${!empty rwy.alternateCode}"> <span class="small ita"> [was ${rwy.alternateCode}]</span></c:if></td>
