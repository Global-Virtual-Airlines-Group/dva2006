...
<tr class="mid">
 <td colspan="2"><img width="${img.width}" height="${img.height}" src="/gallery/${db}/0x<fmt:hex value="${img.ID}" />.${fn:lower(img.typeName)}" alt="${fn:escape(img.name)}, ${img.width}x${img.height} (<fmt:int value="${img.size}" /> bytes)" /></td>
</tr>
</el:table>
