...
<tr class="mid">
 <td colspan="2"><img class="gallery" height="${img.height}" src="/gallery/${db}/${img.hexID}.${img.typeName}" alt="${fn:escape(img.name)}, ${img.width}x${img.height} (<fmt:int value="${img.size}" /> bytes)" /></td>
</tr>
</el:table>
